    ...
    <ThemeProvider>
      <div className="relative min-h-screen bg-[var(--bg-main)] text-[var(--text-main)] selection:bg-rose-500/30 selection:text-rose-200">
        ...
        <div className="sticky top-4 z-40 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <header className="rounded-3xl border-t border-l border-white/35 border-r border-b border-white/10 bg-slate-950/40 backdrop-blur-3xl shadow-[0_20px_60px_rgba(0,0,0,0.5)] transition-all duration-300">
