...
export default function DashboardLayout({
  ...
  return (
    <ThemeProvider>
      <div className="relative min-h-screen bg-[var(--bg-main)] text-[var(--text-main)] selection:bg-[#D4A853]/30 selection:text-[#0A1628]">
          ...
          <header className="rounded-3xl border border-white/10 bg-slate-950/40 backdrop-blur-3xl shadow-[0_20px_60px_rgba(0,0,0,0.5)] transition-all duration-300">
            <div className="flex items-center justify-between px-5 py-3">
              <div className="flex items-center gap-3.5">
                ...
                <div className="relative flex h-10 w-10 items-center justify-center rounded-2xl border-t border-l border-white/50 bg-gradient-to-br from-[#D4A853] via-[#8B94A3] to-[#1E3A5F] text-sm font-black text-[#0A1628] shadow-lg shadow-[#D4A853]/30">
                ...
                <div>
                  <h1 className="text-base font-extrabold tracking-tight text-[var(--text-main)] sm:text-lg">
                    IIT Bhubaneswar <span className="bg-gradient-to-r from-[#D4A853] via-[#8B94A3] to-[#1E3A5F] bg-clip-text text-transparent">Academic Tracker</span>
                  </h1>
                </div>
              </div>

              <div className="flex items-center gap-3">
                <span className="hidden sm:inline-flex items-center gap-1.5 rounded-full border border-[#D4A853]/30 bg-[#D4A853]/10 px-3.5 py-1 text-xs font-bold text-[#D4A853] backdrop-blur-md shadow-sm">
